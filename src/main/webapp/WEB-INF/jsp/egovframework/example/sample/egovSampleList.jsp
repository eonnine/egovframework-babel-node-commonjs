...
<!-- 공통 설정 부분 begin -->
<script src="/resources/script/common/babel-polyfill.js"></script>
<script id="common-js" data-main="/resources/script/common/js-browser/main.js" src="/resources/script/common/common.js"></script>
<!-- 공통 설정 부분 end -->
<script>
module.import('/es/main.js').then(function (module) {
	console.log('module', module);
});

Promise.all([
             module.import('/es/main.js'),
             module.import('/es/test.js'),
           ]).then(function (modules) {
        	   console.log('modules', modules);
           });
           
module.import('/es/asyncExportModule.js').then(function (module) {
